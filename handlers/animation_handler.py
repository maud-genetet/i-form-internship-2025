...
class AnimationHandler:
    ...
    def _start_animation(self):
        ...
        logger.info(
            f"Animation started: frames {self.start_frame}-{self.end_frame}, delay={self.frame_delay}ms")
    ...
    def _initialize_frame_values(self):
        ...
        if hasattr(visualization_manager, 'neu_files') and visualization_manager.neu_files:
            ...
            self.start_frame = 1
            self.end_frame = max_frames
            self.current_frame = visualization_manager.current_mesh_index + \
                1 if hasattr(visualization_manager,
                             'current_mesh_index') else 1
        else:
            self.start_frame = 1
            self.end_frame = 1
            self.current_frame = 1
    ...
    def _load_frame(self, frame_index):
        ...
        if hasattr(visualization_manager, 'neu_files') and visualization_manager.neu_files:
            if 0 <= frame_index < len(visualization_manager.neu_files):
                ...
                preloaded_data = visualization_manager.get_preloaded_data(
                    frame_index)
                ...
                if hasattr(visualization_manager, 'mesh_spinbox'):
                    ...
                    visualization_manager.mesh_spinbox.setValue(
                        frame_index + 1)
